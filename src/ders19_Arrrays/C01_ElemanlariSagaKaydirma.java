...
public class C01_ElemanlariSagaKaydirma {
    ...
    public static int [] sagaKaydir(int [] arr) {
        ...
        int bosKova = arr[arr.length - 1];// son elementi bos kovaya koyduk SON ELEMENTI BOS KOVAYA KOYDUKKK

        for (int i = arr.length - 2; i >= 0; i--) {

            arr[i + 1] = arr[i];
        }
        arr[0] = bosKova;// islem sonu bos kovaya koydugumuz basa atanmasi icin
