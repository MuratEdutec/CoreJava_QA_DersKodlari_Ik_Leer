...
public class C06_soru {
    public static void main(String[] args) {
        ...
        //String cumle= "Eve geldim disler birikmis";
        //String cumle= "Eve geldim merdiven curumuz";
        //String cumle= "Amcama geldim merdiven curumuz";
        ...
        if (cumleCopy.contains("ev") && cumleCopy.contains("is")){
            ...
            System.out.println("ck calisman lazim");
        }
